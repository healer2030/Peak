...
var airports = ["Atlanta (ATL)", "Birmingham (BHM)", "Miami (MIA)", "Huntsville (HSV)", "Orlando (MCO)", "Nashville (BNA)", "Memphis (MEM)", "Charlotte (CLT)", "Raleigh (RDU)", "Greenville (GSP)"];
autocomplete(document.getElementById("f-from"), airports);
autocomplete(document.getElementById("f-to"), airports);
autocomplete(document.getElementById("f-froms"), airports);
autocomplete(document.getElementById("f-tos"), airports);
